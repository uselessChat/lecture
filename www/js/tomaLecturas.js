...
function newGeolocationPosition(){
	var geolocationPosition = {
		set latitude(x){this.x = x;},
		set longitude(y){this.y = y;},
		set altitude(z){this.z = z;},
		set timeStamp(t){this.t = t;},
		get latitude(){return this.x;},
		get longitude(){return this.y;},
		get altitude(){return this.z;},
		get timeStamp(){return this.t;}
	};
	...
	if(checkConnection()){
		navigator.geolocation.getCurrentPosition(
			function geolocationSuccess(position){
				...
				alert('Latitude: '+p.latitude+' Longitud: '+p.longitude+' Time: '+p.timeStamp);
...
function checkConnection(){
	...
	/*if(navigator.connection && navigator.connection.type){
		if(states[navigator.connection.type] != states[Connection.NONE]){
			return true;
		}
	}else{*/
		if(navigator.onLine){
